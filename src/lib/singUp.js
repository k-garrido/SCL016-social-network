      ...
      <ul class="principalUl">
       ...
       <p>O ingresa tu:</p>
        <li class="liInput1">
          ...
          <input class="inputSingUp" type="text" id="name" name="user_name">
        </li>
        <li class="liInput1">
          <label for="mail">Correo:</label>
          <input class="inputSingUp" type="email" id="mail" name="user_mail">
        </li>
       <li class="liInput1">
        <label for="msg">Contraseña:</label>
        <input class="inputSingUp" type="password" id="password" name="user_password"></input>
       </li>
